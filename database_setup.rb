...
conn.exec("create table tweets ( id serial primary key, user_id int references users(id) not null, tweet varchar(140) not null, date_and_time timestamptz default statement_timestamp(), retweet varchar(14));")
